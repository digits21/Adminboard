...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3">
            <!-- Left column -->
            <a href="{{url('user')}}"><strong><i class="glyphicon glyphicon-tasks"></i>Menu</strong></a>

            <hr>

            <ul class="nav nav-stacked">
                <li class="nav-header"> <a href="{{url('projects')}}" data-toggle="collapse" data-target="#userMenu">Pojects <i class="glyphicon glyphicon-chevron-down"></i></a>
        ...
        <div class="col-sm-9">
            ...
            <ul class="list-inline pull-right">
                ...
                <li><a title="Add Widget" href="#"><span class="glyphicon glyphicon-plus-sign"></span> Add Project</a></li>
            </ul>
            @if(Auth::user()->admin==1)
