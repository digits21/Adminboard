    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <ul class="nav nav-stacked">
                ...
                <li class="nav-header"> <a href="{{url('user_reports')}}" data-toggle="collapse" data-target="#menu2"> Reports <i class="glyphicon glyphicon-chevron-right"></i></a>
                ...
                <li class="nav-header">
                    <a href="#" data-toggle="collapse" data-target="#menu3">Profile<i class="glyphicon glyphicon-chevron-right"></i></a>
